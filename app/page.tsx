...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-100 via-blue-50 to-slate-100 flex items-center justify-center p-8 relative overflow-hidden">
      <Card className="w-full max-w-4xl shadow-2xl relative overflow-hidden transition-all duration-500 hover:shadow-[0_0_60px_rgba(59,130,246,0.3)] hover:scale-[1.02] group py-0">
        ...
        <div className="flex">
          <div className="w-[280px] bg-linear-to-b from-blue-50 to-blue-100 p-6 relative z-10">
            <div className="mt-12 mb-6">
              <Avatar className="size-52 mx-auto bg-white transition-all duration-500 hover:scale-110 hover:shadow-2xl relative group/img border-4 border-white">
            ...
            <Card className="mb-6 bg-white/50 backdrop-blur-sm border-0 transition-all duration-300 hover:bg-white/80 hover:shadow-md">
            ...
            <div className="mb-6">
              <h3 className="text-xs font-bold text-blue-700 uppercase mb-3 tracking-wide">Contact Information</h3>
            ...
            <div className="mb-6">
              <h3 className="text-xs font-bold text-blue-700 uppercase mb-3 tracking-wide">Skills</h3>
          ...
          <div className="flex-1 p-8 pl-12">
            <div className="mb-8 mt-16">
              ...
              <h1 className="text-4xl font-bold text-gray-800 mb-1 transition-all duration-500 hover:text-transparent hover:bg-clip-text hover:bg-linear-to-r hover:from-blue-600 hover:to-blue-800 cursor-default">Bat-Erdene</h1>
              <h1 className="text-4xl font-bold text-gray-800 transition-all duration-500 hover:text-transparent hover:bg-clip-text hover:bg-linear-to-r hover:from-blue-600 hover:to-blue-800 cursor-default">Batbold</h1>
            </div>
            ...
            {/* Hobbies Section */}
            <div>
              <h2 className="text-sm font-bold text-blue-700 uppercase mb-6 tracking-wide transition-all duration-300 hover:text-blue-800 hover:translate-x-2">Hobbies</h2>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <Card key={hobby.name} className="transition-all py-0 duration-300 hover:shadow-md hover:scale-105 cursor-pointer group/hobby border-blue-100">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <hobby.Icon className="size-6 text-blue-600 transition-all duration-300 group-hover/hobby:scale-125" />
